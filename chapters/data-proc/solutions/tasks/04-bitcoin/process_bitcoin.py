...
"""
Parse CSV file with Bitcoin history and print statistics.
"""
...
def print_largest_increase_period():
    ...
    print("Largest period of Bitcoin opening increase: {} days starting from {}".format(largest_sequence_size, largest_sequence_start_date))
...
def print_largest_decrease_period():
    ...
    print("Largest period of Bitcoin opening decrease: {} days starting from {}".format(largest_sequence_size, largest_sequence_start_date))
...
def main():
    ...
    with open(FILENAME, 'rt') as csvfile:
        ...
        opening_idx = header.index('open')
        # Read contents.
        for row in reader:
            data.append((row[date_idx], float(row[opening_idx])))
